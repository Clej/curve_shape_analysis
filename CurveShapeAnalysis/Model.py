...
class CurveAnalysis:
    ...
    def __init__(self, grid: skfda.FDataGrid):
        ...
        self._sample_points = self.init_grid.sample_points[0]
    ...
    def smooth_grids(self,
        ...
        self._smoothed = True
        self.coordinates_grids_dx1 = [grid.derivative(1) for grid in self.coordinates_grids]
        self.coordinates_grids_dx2 = [grid.derivative(2) for grid in self.coordinates_grids]
        return None
    ...
    def compute_velocity(self):
        ...
        return skfda.FDataGrid(data_matrix=result_matrix,
                               sample_points=self._sample_points, dataset_label="velocity")
    ...
    def compute_arc_length(self):
        ...
        for i in range(self._nSeries):
            ...
            result_matrix[i, :] = _calculate_arc_length(
                DX1=dx1_mat, t=self._sample_points)
        return skfda.FDataGrid(data_matrix=result_matrix,
                               sample_points=self._sample_points, dataset_label="arc_length")
    ...
    def compute_curvature(self):
        ...
        for i in range(self._nSeries):
            ...
            result_matrix[i, :] = _calculate_curvature(DX1=dx1_mat, DX2=dx2_mat)
        return skfda.FDataGrid(data_matrix=result_matrix,
                               sample_points=self._sample_points, dataset_label="curvature")