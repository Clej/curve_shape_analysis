...
class CurveAnalysis:
    ...
    def smooth_grids(self,
        ...
        if smoother is None:
            ...
            smoother = BasisSmoother(
                BSpline(domain_range=self.init_grid.domain_range, n_basis=15, order=6), regularization=TikhonovRegularization(
    ...
    def plot_grids(self, series_idx=None, targets=None, target_names=None):
        '''
    ...
    def plot_interaction(self, series_idx=None, targets=None, target_names=None):
        '''
